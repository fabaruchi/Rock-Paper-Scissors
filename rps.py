...
"""This player picks moves randomly"""
...
"""This player represents the human player"""
...
"""This player remembers the last move the opponent last played"""
...
"""This player remembers the last move and cycles through the moves"""
...
class Game:
    def __init__(self, p1=HumanPlayer("Player 1"),
                 p2=Player("Player 2")):
        self.score = {1: 0, 2: 0}
        self.p1 = p1  # HumanPlayer
        self.p2 = p2  # ComputerPlayer
    ...
    def player_introduction(self):
        ...
        name = valid_string_input(
            "Nani, Ken or Sebas: ", ["nani", "ken", "sebas"])
        if name == "nani":
        ...
        print_wait(
            f"\n\n{self.p1.name}, you are playing against {self.p2.name}!", 1)
        ...
        while play_again == 'y':
            ...
            if (self.score[1] > self.score[2]):
                ...
                print_wait(
                    ...
                    f"{self.p2.name}. Your opponent! ***", 1, "error")
            else:
